...
define(["dojo/dom", "dojo/on", "dojo/store/JsonRest", "dojo/_base/json", "dojo/data/ObjectStore", "dojo/store/Memory",
    "dojo/store/Cache", "dijit", "dijit/form/ComboBox", "dijit/form/Button", "dijit/form/DateTextBox",
    "dijit/form/MultiSelect", "dojox/grid/EnhancedGrid",  "dojo/_base/lang",  "dojo/dom-class",
    "controllers/widgets/functions.js", "controllers/widgets/notices.js", 
    "dojo/_base/array", "dojo/promise/all", "dojo/Deferred", "dojo/domReady!"],
    function (dom, on, JsonRest, json, ObjectStore, Memory, Cache, dijit, ComboBox, Button, DateTextBox, MultiSelect,
        EnhancedGrid, lang, domClass, Functions, Notices, array, all, Deferred) {
...
//                Function._setJsonRestEndpointTable(jsonStateStore);
                ...
                // Getting doc form content type elements
                nppiPciDesnMemStore = localApp.loadedStores.nppiPciDesnMemory;
