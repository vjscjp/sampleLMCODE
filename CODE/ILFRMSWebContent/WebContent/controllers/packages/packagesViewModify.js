...
function(
    ...
    var code, documentGrid, subClassificationGrid, classificationGrid, packageVersionActive, tempPackageVersionStore = [], versionSelect_packageModify, packageData,
