	...
	return {
		...
		init: function() {
            ...
            dijit.byId("btnSave_packageComments").on("click",function(e){
                //if(dijit.byId("form_packageComments").validate()){
        ...
        saveComment:function(e){
            ...
            var commentObject = {commentText: dijit.byId("txtComment_packageComments").get("Value") }
            ...
            var doneSave = cachePackagesStore.put(commentObject, {}).then(function (results) {
